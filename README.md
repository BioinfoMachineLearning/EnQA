...
```
python3 EnQA.py --input example/model/6KYTP/test_model.pdb --output outputs/ --model_path models/egnn_ne.tar --disto_type esto9 --model_type egnn_ne --alphafold_prediction example/alphafold_prediction/6KYTP/
```
