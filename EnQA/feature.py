...
def get_dan_feature(model_pdb, out_path, dan_path='utils/DeepAccNet/DeepAccNet-noPyRosetta.py'):
...
def process_data(input_model_path, output_feature_path, template_path=None,
    ...
    if disto_type == 'base':
        f2d_dan = get_dan_feature(input_model_path, output_feature_path)
